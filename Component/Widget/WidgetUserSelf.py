...
class WidgetUserSelf(QWidget):
    ...
    def __variables__(self):
        self.columnsUser, self.listSelf = self.connUser.ColumnAndListSelf(self.userName)
        self.objText = ['성명',
                        '입사일',
                        '소속',
                        '직위',
    ...
    def __button__(self):
        ...
        self.btnClose.clicked.connect(self.dock.close)
    ...
    def __layout__(self):
        ...
        layoutHorizontal.addWidget(QLabel(''), 2)
