...
class TableInquiryTimePerUser(QTableWidget):
    def __init__(self, year, userName, widget=None):
    ...
    def __variables__(self):
        self.columnsTotal, self.dfTotal = self.connMain.DfTotalTimePerUser(self.year, self.userName)

    def __component__(self):
        self.__tblUserTime__()

    def __tblUserTime__(self):
